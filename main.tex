...
Grazie a questo incremento la statement coverage è salita al 82\% (Figura \ref{fig:JacocoCoveragereadHeader3}) 
e la condition coverage al 77\% (Figura \ref{fig:JacocoCoveragereadHeader4})
...
Dalla Figura \ref{fig:readHeader_badua} possiamo calcolare la all uses coverage. \\
...
\begin{table}[ht]
  ...
  \begin{tabular}{|l|l|l|l|l|l|l|}
    ...
    BKLE & new byte[1] & 1 & 0 & 1 & 15 & Success \\
    BKLE & new byte[1] & 1 & 0 & 1 & -1 & Success \\
    \hline
  \end{tabular}
